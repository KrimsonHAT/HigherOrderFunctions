...
for(let i = max; i >= min; i--){
   ...
   option.value = i;
   option.innerText = i;
   const resultado = document.getElementById('year')
...
function mostrarAutos(autos){
    ...
    autos.forEach(auto => {
        ...
        autoHTML.innerHTML = `
            <p>${auto.marca}  ${auto.modelo} -Año ${auto.year} -Puertas: ${auto.puertas} -Precio: ${auto.precio}
            -Transmisión: ${auto.transmision} -Color: ${auto.color}</p>
        `;
...
function noResultados(){
    ...
    noResultados.appendChild(document.createTextNode('No hay resultados'))
